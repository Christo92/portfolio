...
// Img
import project1 from "../img/crud-mern.jpg";
        ...
        <div key="1" className="works__container">
          ...
          <div className="works__lists">
            <div className="works__project">
              ...
              <a
                className="works__project-title"
                href="https://www.smart-tribune.com/fr/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Smart-tribune (ReactJS)
              </a>
            </div>
            <div className="works__project">
              <img className="works__mission" src={project6} alt="" />
              <p className="works__project-title">Easy Forward Music</p>
            </div>
            <div className="works__project">
              <img className="works__mission" src={project1} alt="" />
              <a
                className="works__project-title"
                href="https://crud-mern-project.herokuapp.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                Crud MERN Stack (Mongo, Express, ReactJS, Node)
              </a>
            </div>
            <div className="works__project">
              ...
              <a
                className="works__project-title"
                href="https://github.com/Christo92/web-devtips"
                target="_blank"
                rel="noopener noreferrer"
              >
                Web-devtips (list of my notes in web development)
              </a>
            </div>
            <div className="works__project">
              <img className="works__mission" src={project6} alt="" />
          ...
          <Link to="/home" className="works__to-home">
            {" "}
            > Retour à l'accueil
          </Link>
        </div>
